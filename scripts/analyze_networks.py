...
def load_committees():
    ...
    df = pd.read_csv(committee_files[0], skiprows=1, encoding='latin-1', on_bad_lines='skip', engine='python')
...
def load_contributions():
    ...
    for f in contrib_files:
        ...
        try:
            ...
            df = pd.read_csv(f, skiprows=1, encoding='latin-1', on_bad_lines='skip', engine='python')
            dfs.append(df)
